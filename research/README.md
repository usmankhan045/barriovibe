...
| `OPEN-ITEMS.md` | Verification items that block specific articles, each with what to fetch. Live count is in findings.jsonl: 19 contested or unverified. |
...
Nineteen of the 284 findings are recorded specifically so they are never used
