...
### 2.3a What a website actually costs, by scope decision  *(WRITTEN, 29 Oct)*
...
### 2.3b Why software estimates are wrong, and what to do about it  *(WRITTEN, 30 Oct)*
...
### 2.4 Why your AI bill exceeded the estimate  *(WRITTEN, 2 Nov)*
...
### 2.5 What a chatbot costs, by what you actually want it to do  *(WRITTEN, 4 Nov)*
...
### 6.1 You probably do not own the code you paid for  *(WRITTEN, 31 Oct)*
...
### 6.1a Who owns what the AI wrote  *(WRITTEN, 3 Nov)*
...
### 6.2 Fixed price or time and materials  *(WRITTEN, 1 Nov)*
...
### 6.3 Agent washing: auditing a vendor's AI claim  *(WRITTEN, 5 Nov)*
...
### 6.4a Why offshore comparisons have no evidence behind them  *(WRITTEN, 7 Nov)*
...
### 6.5 What happens when the agency disappears  *(WRITTEN, 6 Nov)*
